...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('servicebehaviorcomponent_ptr', models.OneToOneField(to='shuup.ServiceBehaviorComponent', parent_link=True, serialize=False, primary_key=True, auto_created=True)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('paymentprocessor_ptr', models.OneToOneField(to='shuup.PaymentProcessor', parent_link=True, serialize=False, primary_key=True, auto_created=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', enumfields.fields.EnumIntegerField(blank=True, verbose_name='Transaction status', default=0, enum=shuup_cielo.constants.CieloTransactionStatus)),
                ...
                ('total_value', shuup.core.fields.MoneyValueField(max_digits=36, editable=False, default=0, verbose_name='transaction total', decimal_places=9)),
                ('total_captured_value', shuup.core.fields.MoneyValueField(max_digits=36, verbose_name='total captured', default=0, decimal_places=9)),
                ('total_reversed_value', shuup.core.fields.MoneyValueField(max_digits=36, verbose_name='total reversed', default=0, decimal_places=9)),
                ...
                ('order', models.ForeignKey(related_name='cielows15_transactions', verbose_name='Order', to='shuup.Order')),
            ],
            options={
