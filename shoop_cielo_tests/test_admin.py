...
from shoop_cielo_tests.test_checkout import get_payment_provider
...
def test_refresh_transaction_view(rf, admin_user):
    ...
    view = load("shoop_cielo.admin.views.RefreshTransactionView").as_view()
...
def test_capture_transaction_view(rf, admin_user, with_amount):
    ...
    view = load("shoop_cielo.admin.views.CaptureTransactionView").as_view()
    request = apply_request_middleware(rf.post("/"), user=admin_user)
...
def test_cancel_transaction_view(rf, admin_user, with_amount):
    ...
    view = load("shoop_cielo.admin.views.CancelTransactionView").as_view()
    request = apply_request_middleware(rf.post("/"), user=admin_user)
