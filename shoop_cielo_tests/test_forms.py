...
from shoop_cielo.constants import CieloAuthorizationType, CieloCardBrand, InterestType
from shoop_cielo.forms import CieloPaymentForm
from shoop_cielo.models import CieloWS15PaymentProcessor, InstallmentContext
...
def test_form_installment_context():
    ...
    assert form.currency == settings.SHOOP_HOME_CURRENCY
