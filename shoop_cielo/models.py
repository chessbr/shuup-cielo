...
from shoop_cielo.utils import decimal_to_int_cents, InstallmentCalculator, safe_int
...
from shoop.core.models._service_base import ServiceBehaviorComponent, ServiceCost
...
class CieloWS15PaymentProcessor(PaymentProcessor):
    ...
    def get_payment_process_response(self, service, order, urls):
        ...
        try:
            ...
            # TODO: Quando o Shoop possibilitar a retentativa de pagamento
...
class CieloWS15Transaction(models.Model):
    order = models.ForeignKey('shoop.Order',
